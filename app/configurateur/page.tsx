...
export default function ConfiguratorPage() {
  return <>
    <section className="pb-12 pt-32 md:pb-16 md:pt-40">
      <Container>
        <p className="eyebrow">Personnalisation professionnelle</p>
        <h1 className="mt-5 max-w-5xl font-[var(--font-display)] text-[clamp(2.8rem,7vw,6.5rem)] leading-[.95] tracking-[-.055em]">Configurez votre Un1qpen</h1>
