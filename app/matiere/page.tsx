import { MaterialProcess, MaterialTouchSection, ProductComparison } from "@/components/sections/HomeSections";
...
export default function Page(){return <><PageHero eyebrow="La matière" title="Transformer la fibre. Préserver son histoire." intro="Une matière élaborée principalement à partir de déchets textiles industriels fortement chargés en polyester."/><MaterialProcess/><MaterialTouchSection/><EditorialBlocks blocks={[
