...
export function Footer() { return <footer className="bg-[#123b57] py-16 text-white">
  <div className="container grid gap-12 md:grid-cols-[1.3fr_1fr_1fr]">
    <div><Link href="/" aria-label="UN1QPEN, accueil"><Image src="/images/un1qpen-logo.png" alt="UN1QPEN" width={188} height={44} className="h-auto w-[170px] invert"/></Link><p className="mt-5 max-w-sm text-white/60">{site.tagline}<br/>Site destiné aux professionnels.</p></div>
