...
export function HeroSection() {
  ...
  return <section className="hero-home relative flex min-h-[100svh] items-center overflow-hidden bg-[#f7f6f3] pb-7 pt-24 text-[#1d1d1f]">
    <div className="absolute inset-y-[5%] right-0 w-[92%] bg-[#f7f6f3]">
      <HeroColorVisual/>
    </div>
    <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(247,246,243,.98)_0%,rgba(247,246,243,.94)_34%,rgba(247,246,243,.62)_48%,rgba(247,246,243,0)_66%)] max-md:bg-[linear-gradient(90deg,rgba(247,246,243,.97),rgba(247,246,243,.84))]"/>
    <Container className="relative z-10">
      ...
      <a href="#decouvrir" aria-label="Faire défiler" className="absolute bottom-0 right-0 grid size-12 place-items-center rounded-full border border-black/20 bg-white/50 backdrop-blur"><ArrowDown size={18}/></a>
    </Container>
  </section>;
}
  ...
  return <section className="section overflow-hidden bg-[#eef2f4]">
    <Container>
      <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:items-end">
        ...
        <AnimatedReveal className="relative min-h-[420px] overflow-hidden rounded-[2rem] bg-white shadow-[0_30px_80px_rgba(23,72,106,.12)]">
