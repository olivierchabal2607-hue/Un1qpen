...
export function QuoteSection() { return <section className="textile-surface section bg-[#87a8b9] text-center"><Container><p className="mx-auto max-w-6xl font-[var(--font-serif)] text-[clamp(3rem,7vw,7rem)] leading-[1.02] tracking-[-.04em]"><span className="text-[#0055a4]">Plus de solutions,</span><br/><span className="text-white">moins de pollution…</span><br/><span className="text-[#ef4135]">Des idées sans pétrole ajouté&nbsp;!</span></p></Container></section>; }
